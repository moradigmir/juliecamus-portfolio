          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            >
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="font-inter text-muted-foreground">julie@juliecamus.com</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="font-inter text-muted-foreground">+33 1 42 86 87 88</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="font-inter text-muted-foreground">@juliecamus_makeup</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-card border border-border rounded-lg p-6">
                <h3 className="font-playfair text-xl font-semibold text-card-foreground mb-4">
                  Services
                </h3>
